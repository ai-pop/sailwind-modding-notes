...
### SailwindItemPhysics v4.6 crash investigation — Round 3 (A1–A8, B1–B7)
> Vanilla drop/throw, clickability, velocity zeroing, buoyancy.

| № | File | Topic |
|---|------|------|
| 57 | [vanilla-drop-throw-mechanics.md](57-vanilla-drop-throw-mechanics.md) | **A1+A2:** DropItem (4 lines), ThrowItemAfterDelay, throw charge |
| 58 | [clickability-layers-manual-held-break.md](58-clickability-layers-manual-held-break.md) | **A3+A4:** OnDrop/OnPickup verbatim, skip consequences table, layer lifecycle |
| 59 | [velocity-zeroing-release-frame-pose.md](59-velocity-zeroing-release-frame-pose.md) | **A5+A6:** velocity zeroed by FixedUpdate position snap, release frame pose |
| 60 | [held-readers-throw-key-binding.md](60-held-readers-throw-key-binding.md) | **A7+A8:** complete held readers table, InputName 10 throw key |
