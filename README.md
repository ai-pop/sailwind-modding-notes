...
### Исследование мода SailwindItemPhysics v4.6 — раунд 3 (A1–A8, B1–B7)
> Ванильный дроп/бросок, кликабельность, зануление velocity, плавучесть.

| № | Файл | Тема |
|---|------|------|
| 57 | [vanilla-drop-throw-mechanics.md](57-vanilla-drop-throw-mechanics.md) | **A1+A2:** DropItem (4 строки), ThrowItemAfterDelay, throw charge |
| 58 | [clickability-layers-manual-held-break.md](58-clickability-layers-manual-held-break.md) | **A3+A4:** OnDrop/OnPickup вербатим, table последствий пропуска, layer lifecycle |
| 59 | [velocity-zeroing-release-frame-pose.md](59-velocity-zeroing-release-frame-pose.md) | **A5+A6:** velocity обнуляется FixedUpdate position snap, pose в кадре релиза |
| 60 | [held-readers-throw-key-binding.md](60-held-readers-throw-key-binding.md) | **A7+A8:** полная таблица held readers, InputName 10 throw key |
...
├── LICENSE                        ← MIT
├── 01-textmesh-not-tmp.md ... 68-*.md   ← 68 заметок (RU)
└── en/
    ├── README.md                  ← English translation
    ├── 01-textmesh-not-tmp.md ... 68-*.md   ← 68 заметок (EN)
```
